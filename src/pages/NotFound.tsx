    ...
    <div className="surface-ivory">
      <div className="container-western max-w-2xl py-16 md:py-24">
        ...
        <p className="text-body mt-5">
          O caminho{" "}
          <code className="break-all rounded-[6px] border border-western-border-soft bg-western-paper px-1.5 py-0.5 font-sans text-[16px] text-western-green-deep">
            {location.pathname}
          </code>{" "}
        ...
        <ul className="mt-8 overflow-hidden rounded-[10px] border border-western-border-soft bg-white">
          {SUGESTOES.map((s) => (
