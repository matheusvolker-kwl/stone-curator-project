  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#E6DCC6] font-sans text-[#3E5058]">
      <Seo
        ...
        description="Concha, borda e assento esculpidos numa única forma contínua. Água aquecida o ano inteiro, hidro, LED e tratamento sem cloro. 3,00 × 2,00 m — varandas, decks e jardins."
        path="/una"
      ...
      <div className="relative overflow-hidden bg-[#14262B]">
        <img src="/una/capa-una.jpg" alt="" aria-hidden className="absolute inset-0 h-full w-full object-cover opacity-[.62]" />
        ...
        <div className="relative mx-auto flex min-h-[92vh] max-w-[1100px] flex-col px-6 md:px-8">
          ...
          <div className="flex flex-1 flex-col justify-center gap-6 pb-24 pt-16">
            ...
            <p className="text-[15px] text-[#E6DCC6]/55">3,00 × 2,00 m · até 6 pessoas · varandas, decks, coberturas e jardins</p>
          </div>
        </div>
      </div>
      ...
      <section id="peca" className="bg-[#E6DCC6]">
        <div className="mx-auto flex max-w-[1100px] flex-col gap-14 px-6 py-24 md:px-8">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
            {MACROS.map((m) => (
              <figure key={m.titulo} className="relative m-0 min-h-[420px] overflow-hidden rounded-2xl">
                <img src={m.img} alt={m.alt} loading="lazy" className="absolute inset-0 h-full w-full object-cover" />
      ...
      <section id="tons" className="bg-[#E6DCC6]">
        <div className="mx-auto flex max-w-[1100px] flex-col gap-12 px-6 py-24 md:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {AMBIENTES.map((a) => (
              <figure key={a.legenda} className="relative m-0 min-h-[340px] overflow-hidden rounded-2xl">
      ...
      <section id="como" className="bg-[#E6DCC6]">
        <div className="mx-auto flex max-w-[1100px] flex-col gap-11 px-6 py-24 md:px-8">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {PASSOS.map((p, i) => (
              <div key={p.titulo} className="flex flex-col gap-2 rounded-[14px] bg-white px-7 py-6">
      ...
      <section id="contato" className="bg-[#F0E8DA]">
        <div className="mx-auto grid max-w-[1100px] grid-cols-1 items-center gap-14 px-6 py-24 md:grid-cols-2 md:px-8">
          <div className="flex flex-col gap-5">
            ...
            <h2 className="font-display text-[clamp(28px,4vw,40px)] font-[650] leading-[1.12] tracking-[-.015em] text-[#1B3640] [text-wrap:pretty]">
              Valores sob consulta, direto do ateliê.
            </h2>
            <p className="text-lg leading-relaxed [text-wrap:pretty]">
