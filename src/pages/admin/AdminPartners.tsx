...
/**
 * O que o percentual significa na tabela comercial (regra de 31/08/2026).
...
const SIGNIFICADO_TIER: Record<Tier, string> = {
  padrao: "40% de margem sobre a venda sugerida",
  vitrine: "45% de margem sobre a venda sugerida",
  partner: "50% de margem — a tabela R02FEV2025",
};
          ...
          <div className="rounded-xl border border-western-border-strong bg-white p-6">
            ...
            {aprovado && (
              <div className="mt-5 rounded-lg border border-western-border-soft bg-western-paper p-4">
                ...
                {/* O percentual e verdadeiro mas nao comunica nada: 16,6667% nao
