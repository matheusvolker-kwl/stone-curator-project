...
export default function GuideHeader({ breadcrumb }: Props) {
  return (
    <header className="border-b border-western-stone-warm/15 bg-western-ivory/95 backdrop-blur-sm sticky top-0 z-30 relative">
      <div className="container-western h-16 flex items-center justify-between">
        <Link
          to="/"
      ...
      {breadcrumb && (
        <div className="md:hidden container-western pb-3">
          <Link
            to={breadcrumb.to}
