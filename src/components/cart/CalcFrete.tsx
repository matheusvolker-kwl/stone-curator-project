...
export default function CalcFrete() {
  ...
  return (
    <div className="border border-western-gold/25 bg-western-green-deep/40 p-4 md:p-5 space-y-4">
      ...
      <div className="flex gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            inputMode="numeric"
            className="w-full h-11 pl-8 pr-3 bg-transparent border border-western-gold/30 text-western-cream placeholder:text-western-cream-muted/60 font-mono text-sm tracking-wider focus:border-western-gold focus:outline-none"
        ...
        <button
          ...
          onClick={handleCalc}
          disabled={loading}
          className="h-11 px-4 bg-western-gold text-western-green-deep font-mono text-[11px] uppercase tracking-[0.22em] hover:bg-western-gold/90 disabled:opacity-50 inline-flex items-center gap-2"
        >
          {loading ? (
            <>
      ...
      {erro === "cep_invalido" && (
        <p className="text-spec text-red-300/80 text-xs">CEP inválido. Verifique os 8 dígitos.</p>
      )}
      ...
      {(showOpcoes || showFallback) && (
        <div className="space-y-3 pt-2 border-t border-western-gold/15">
          ...
          <p className="text-spec text-western-cream-muted/70 text-[10px] leading-relaxed pt-1">
