  ...
  return (
    <div>
      ...
      <button
        ...
        className="w-full h-[52px] rounded-[6px] border border-western-border-strong hover:border-western-green-deep transition-colors flex items-center justify-center gap-2 font-sans text-[16px] font-semibold text-western-green-deep disabled:opacity-50"
      >
