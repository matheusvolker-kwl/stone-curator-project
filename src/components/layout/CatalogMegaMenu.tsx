    ...
    >
      ...
      {open && (
        <div className="absolute left-0 top-full z-50 pt-3">
          <div className="w-[720px] max-w-[calc(100vw-2rem)] overflow-hidden rounded-[16px] border border-western-border-soft bg-white shadow-[0_20px_50px_-12px_rgba(23,32,24,0.28)]">
