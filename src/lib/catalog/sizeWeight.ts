...
// presente no descriptionHtml dos produtos, e classifica em buckets.

import { parseProductDescription } from "./parseDescription";
import type { CatalogProductNode } from "./types";
...
export function extractSizeWeight(product: CatalogProductNode): SizeWeight {
